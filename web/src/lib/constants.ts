...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  { id: "intel_btn", title: "Intel Qualitativa", body: "Clique em '⚠ Intel' para registrar informações como lotação, falta de recurso, recurso normalizado ou envio planejado. Cada registro mostra quem informou e quando.", target: "btn-intel", pos: "bottom" },
  { id: "remove_intel", title: "Remover Intel", body: "Abaixo você vê o painel de detalhes do HGE. A intel 'Lotado' aparece com o botão '✕ Remover'. Ao clicar, fica registrado quem removeu e quando — ex: quando a sala vermelha liberar leitos.", target: "detail-intel", selectHospital: "hge", pos: "right" },
